...
if (isset($_GET['code'])) {
    ...
    $sql_lietke_dh = "SELECT tbl_cart_details.*, tbl_sanpham.*, size.ten_size, tbl_donhang.id_khachhang_temp AS donhang_id_khachhang_temp, tbl_donhang.code_cart, tbl_donhang.tenkhachhang, tbl_donhang.diachi, tbl_donhang.dienthoai
    ...
    $sql_lietke_dhs = "SELECT tbl_cart_details.*, tbl_sanpham.*, size.ten_size, tbl_donhang.id_khachhang_temp AS donhang_id_khachhang_temp, tbl_donhang.code_cart, tbl_donhang.tenkhachhang, tbl_donhang.diachi, tbl_donhang.dienthoai
    FROM tbl_cart_details
    INNER JOIN tbl_sanpham ON tbl_cart_details.id_sanpham = tbl_sanpham.id_sanpham
    INNER JOIN size ON tbl_cart_details.size = size.id_size
    LEFT JOIN tbl_donhang ON tbl_cart_details.code_cart = tbl_donhang.code_cart
