                    ...
                    <div class="product-details">
                        <div class="product-info">
                            ...
                            <form id="productForm" method="POST"
                                action="./pages/main/themgiohang.php?idsanpham=<?php echo $row_sanpham['id_sanpham'] ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Tìm phần tử input đầu tiên với name="kichthuoc"
        ...
        if (firstSizeInput) {
            ...
            // Lấy giá trị soluongconlai từ data-value của kích thước đầu tiên
            var firstSizeValue = firstSizeInput.getAttribute('data-value');

            // Gọi hàm enableQuantity với giá trị soluongconlai tương ứng
    ...
    function enableQuantity(maxSoluong) {
        ...
        // Đặt giá trị max cho số lượng
        soluongInput.max = maxSoluong;

        // Nếu muốn đặt số lượng mặc định là 1, hãy sử dụng dòng sau
        soluongInput.value = 1;

        // Kích hoạt ô nhập số lượng
        soluongInput.disabled = false;

        // Cập nhật nhãn số lượng
        updateQuantityLabel(1); // Giả sử số lượng mặc định là 1
    }
</script>