...
<div class="modals">
    ...
    if (isset($_SESSION['id_khachhang'])) {
        ...
        $sql_giohang = "SELECT giohang.*, sanpham.tensanpham, sanpham.giasp, sanpham.hinhanh, size.ten_size,sanpham.km
        ...
        while ($cart_item = mysqli_fetch_assoc($query_giohang)) {
            $thanhtien = $cart_item['soluong'] * (($cart_item['km'] > 0) ? $cart_item['giasp'] - ($cart_item['giasp'] * ($cart_item['km'] / 100)) : $cart_item['giasp']);
            $tongtien += $thanhtien;
            ...
            $product_price = ($cart_item['km'] > 0) ? $cart_item['giasp'] - ($cart_item['giasp'] * ($cart_item['km'] / 100)) : $cart_item['giasp'];
            ...
            if ($cart_item['km'] > 0) {
                echo '<span class="pro-price-del"><span class="original-price">' . number_format($cart_item['giasp']) . '₫</span></span>';
            }
            ?>
        </p>
